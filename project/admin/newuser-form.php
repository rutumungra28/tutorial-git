...
if(isset($_POST['submit']))
{
  ...
  }else
  {
    ...
    $status=1; 
    $sql="INSERT INTO  users(name,username,email,password,status,mobile,sex,lastname,permission) VALUES(:name,:username,:email,:password,:status,:mobile,:sex,:lastname,:permission)";
