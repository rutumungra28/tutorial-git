...
//} else{
  if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  customers(name,email,mobilenumber,gender,details) value('$name','$email','$mobilenum','$gender','$details')");
    if ($query) {
  ...
  <body class="hold-transition sidebar-mini">
    <div class="wrapper" style="background-image:url(images/head1.jpg)">
      <!-- Navbar -->
            ...
            <div class="row offset-md-1">
             <div class="col-md-8 mr-3">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" style="background-image:url(images/head4.jpg)">
                  <div class="card-body">
