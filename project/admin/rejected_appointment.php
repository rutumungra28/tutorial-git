...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper" style="background-image:url(images/head6.jpg)">
	  ...
	  <div class="col-sm-6">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-header" style="background-image:url(images/head6.jpg)">
                ...
                <div id="editData" class="modal fade">
                  <div class="modal-dialog ">
                    <div class="modal-content">
                      ...
                      <div class="modal-body" id="info_update" style="background-image:url(images/head6.jpg)">
               ...
               <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php
                    $ret=mysqli_query($con,"select *from  appointment where status='2'");
                    $cnt=1;
