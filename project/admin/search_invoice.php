            ...
            { 
              ...
              <h5 align="center" style="color: blue;" class="mb-3">Result against "<?php echo $sdata;?>" keyword </h4> 
                <table class="table table-bordered"> 
                  ...
                  <tbody>
                    <?php
                    $ret=mysqli_query($con,"select distinct  customers.name,invoice.billingid,invoice.postingdate from  customers   
                      join invoice on customers.id=invoice.userid  where invoice.billingid like '%$sdata%'");
